...
def add_config(parser):
    ...
    group.add_argument("-version", type=str, default="2.1",
                       choices=["2.0", "2.1", "2.3", "2.4", "fused"])
    group.add_argument("-task", type=str, default="e2e",
                       choices=["dst", "e2e"])
    group.add_argument("-add_auxiliary_task", action="store_true")
    group.add_argument("-add_mode_predict", type=int, default=0)
    group.add_argument("-add_cl_loss", type=int, default=0)
    group.add_argument("-add_adapter", type=int, default=0)
    ...
    group.add_argument("-dataset", type=str, default="multiwoz",
                       choices=["multiwoz", "salesbot"])
    group.add_argument("-prefix_len", type=int, default=30)
    ...
    group.add_argument("-kl_loss_coeff", type=float, default=1.0)
    ...
    group.add_argument("-temper", type=float, default=0.1)
    group.add_argument("-latent_size", type=int, default=768)
    group.add_argument("-train_ratio", type=float, default=1.0)
...
def check_config(parser):
    ...
    # update arguments for consistency with checkpoint models
...
def get_config():
    ...
    parser = argparse.ArgumentParser(
        description="Configuration of task-oriented dialogue models with multi-task learning.")
